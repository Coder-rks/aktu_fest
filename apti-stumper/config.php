...
$CFG->dbhost    = 'mysql';  // eg 'mysql' or 'db.isp.com' or IP
$CFG->dbname    = 'u607794729_ajeva';     // database name, eg moodle
$CFG->dbuser    = 'u607794729_amybu';   // your database username
$CFG->dbpass    = 'yNuMumyZaG';   // your database password
$CFG->prefix    = 'zv3c_';       // prefix to use for all table names
$CFG->dboptions = array(
    ...
    'dbsocket'  => false,       // should connection via UNIX socket be used?
                                ...
                                //  here set dbhost to 'mysql',
                                //  (please note mysql is always using socket
                                //  if dbhost is 'mysql' - if you need
...
$CFG->wwwroot   = 'http://nutter.xyz/apti-stumper';
...
$CFG->dataroot  = '/home/u607794729/public_html/apti-stumper/data';
